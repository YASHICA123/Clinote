...
**Recent Commits:**
- `53d2864 Initialize Clinote clinical platform`
...
1. **Load context, then search before you change.** Run `continuity context` at session start (see above), then `continuity search "<topic>"` before proposing changes (`grep -i "<topic>" .continuity/decisions.json` only if the CLI is unavailable). Name any conflict with a prior decision and let the user choose.
...
*Auto-generated by Continuity | Updated: 2026-07-17*
